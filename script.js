    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Lumber Legends משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '7d27206f-c92d-417d-85df-be8ca2fce0c7',
                    name: data.name || '',
                    email: data.email || '',
